...
import { getResourceInfo, getSolidDataset, getThing, getUrl, getUrlAll, overwriteFile, saveSolidDatasetAt, setThing, setUrl } from '@inrupt/solid-client'
...
import { CardContent, Container, Grid, Input, Typography, Card, Button } from "@material-ui/core"
        ...
        <Card>
          <CardContent>
            ...
            <Typography gutterBottom variant="h6" component="h3">
              To make full use of the Mellon dashboard, please fill in all fields.
            </Typography>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={9} className="valueParent">
                <Value autosave edit={edit} dataType="url" property={LDP.inbox}/>
              </Grid>
            </Grid>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={9} className="valueParent">
                <Value autosave edit={edit} dataType="url" property={AS.NAMESPACE + "outbox"}/>
              </Grid>
              ...
              <Grid item xs={12} sm={3}>
                ...
                <Typography gutterBottom variant="h6" component="h3">
                  URI of file storing an index of your linked files linked from your profile
                </Typography>
              </Grid>
              <Grid item xs={12} sm={9} className="valueParent">
                <Value autosave edit={edit} dataType="url" property={SOLID.publicTypeIndex}/>
              </Grid>
              ...
              <Grid item xs={12} sm={9} className="valueParent">
                <Value autosave edit={edit} dataType="url" property={ORCHESTRATORPREDICATE}/>
              </Grid>
            </Grid>
            {edit
            ?<Button type="submit" onClick={handleSubmit} > Ready </Button>
            :<Button type="submit" onClick={() => setEdit(!edit)} > Edit </Button>
            }
          </CardContent>
        </Card>
      </Container> }
...
export async function isInitialized(session) {
  ...
  let profileThing = getThing( await getSolidDataset(webId, {fetch: session.fetch}), webId )
  let requiredProperties = [LDP.inbox, AS.NAMESPACE + "outbox", SOLID.publicTypeIndex, ORCHESTRATORPREDICATE]
